...
So we started Wikitravel in 2003 and had that first kind of exciting point of launching the site, getting the first group of users involved - a lot of people who were involved in Wikipedia - and then having a number of articles come out about the project... Oh, god. I mean, our first articles were like on [Advogato](https://en.wikipedia.org/wiki/Advogato) and [Kuro5shin](https://en.wikipedia.org/wiki/Advogato). There are two names I've not heard in a long time, but they gave us--and [Slashdot!](https://slashdot.org)--they gave us the boost that we needed to really get that virtuous cycle going with that site.
